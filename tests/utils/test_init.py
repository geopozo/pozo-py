...
def test_is_close():
    ...
    assert pzutils.is_close(series[0], series[-1], True, series[1]-series[0], 0.001) is not None
    assert pzutils.is_close(series_polars[0], series_polars[-1], True, series_polars[1]-series_polars[0], 0.001) is not None
    ...
    assert pzutils.is_close(series_data_irregular[0], series_data_irregular[-1], True, series_data_irregular[1]-series_data_irregular[0], 0.001) is not None
    assert pzutils.is_close(series_polars_data_irregular[0], series_polars_data_irregular[-1], True, series_polars_data_irregular[1]-series_polars_data_irregular[0], 0.001) is not None
